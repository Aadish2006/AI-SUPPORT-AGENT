      ...
      <div className="p-6 max-w-6xl w-full mx-auto space-y-6">
        <div className="glass-card relative overflow-hidden p-6 sm:p-7 bg-gradient-card">
          ...
          <div className="relative flex flex-col gap-2">
            ...
            <h1 className="text-2xl sm:text-3xl font-bold text-white tracking-tight">Escalation Queue</h1>
            <p className="text-sm text-gray-400 max-w-2xl leading-relaxed">
              Review tickets handed off by the assistant and mark them resolved when a human follow-up is complete.
            </p>
          </div>
        </div>
